...
<%@include file="./includes/header.jsp" %>
				<main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>BBS Modify Page</div>
                            <div class="card-body">
                                <div class="table-responsive">
                                	<form role="from" action="/board/modify" method="post">
                                    	...
                                    	<input type="hidden" name="pageNum" id="pageNum" value="${crt.pageNum}"/>
                                    	<input type="hidden" name="amount" id="amount" value="${crt.amount}"/>
